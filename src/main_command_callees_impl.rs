//! Implementation of the callees command (function callee search).
//!
//! This module maps to hierarchical name: main.command.callees.impl

use recur::output::{JsonFormatter, TerminalFormatter};
use recur::parser::HierarchyPattern;
use recur::search::{read_paths_from_stdin, CalleeSearcher, SearchOptions};
